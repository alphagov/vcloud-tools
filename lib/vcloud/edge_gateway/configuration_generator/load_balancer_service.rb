    ...
    module ConfigurationGenerator
      class LoadBalancerService
        ...
        def look_up_network_href(name)
          'http://example.com/api/admin/network/12345678-1234-1234-1234-123456789012'
        end
        ...
        def generate_vs_service_profile_protocol_section(protocol, attrs)
          attrs = {} if attrs.nil?
          out = {}
          out[:IsEnabled] = attrs.key?(:enabled) ? attrs[:enabled].to_s : 'false'
          out[:Protocol] = protocol.to_s.upcase
